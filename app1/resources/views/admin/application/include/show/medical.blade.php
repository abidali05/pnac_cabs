                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $medical->organisation }}" name="organisation" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address of Medical laboratory</label>
                            <input type="text" value="{{ $medical->address_medical }}" name="address_medical" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{ $medical->postcode }}" name="postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $medical->tel }}" name="tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $medical->fax }}" name="fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $medical->contact_name }}" name="contact_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Designation:</label>
                            <input type="text" value="{{ $medical->designation }}" name="designation" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address:</label>
                            <input type="text" value="{{ $medical->person_address }}" name="person_address" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Postcode</label>
                                <input type="text" value="{{ $medical->person_postcode }}" name="person_postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Tel</label>
                                <input type="text" value="{{ $medical->person_tel }}" name="person_tel" readonly class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Fax</label>
                                <input type="text" value="{{ $medical->person_fax }}" name="person_fax" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Mobile</label>
                                <input type="text" value="{{ $medical->person_mobile }}" name="person_mobile" readonly class="form-control">
                            </div>
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" value="{{ $medical->selves_title }}" name="selves_title" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>name</label>
                            <input type="text" value="{{ $medical->selves_name }}" name="selves_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Position</label>
                            <input type="text" value="{{ $medical->selves_position }}" name="selves_position" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $medical->selves_parent_organization }}" name="selves_parent_organization" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $medical->selves_parent_address }}" name="selves_parent_address" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Postcode</label>
                            <input type="text" value="{{ $medical->selves_parent_postcode }}" name="selves_parent_postcode" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Tel</label>
                            <input type="text" value="{{ $medical->selves_parent_tel }}" name="selves_parent_tel" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Fax</label>
                            <input type="text" value="{{ $medical->selves_parent_fax }}" name="selves_parent_fax" readonly class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            <label>Organization</label>
                            <input type="text" value="{{ $medical->selves_invoicing_organization }}" name="selves_invoicing_organization" readonly class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $medical->selves_invoicing_address }}" name="selves_invoicing_address" readonly class="form-control">
                        </div>

                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{ $medical->selves_invoicing_postcode }}" name="selves_invoicing_postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $medical->selves_invoicing_tel }}" name="selves_invoicing_tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $medical->selves_invoicing_fax }}" name="selves_invoicing_fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $medical->selves_other_describe }}" name="selves_other_describe" readonly class="form-control">
                        </div>
                        <div class="form-group">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $medical->staff_laboratory }}" name="staff_laboratory" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Name & Designation of Signatory</label>
                            <input type="text" value="{{ $medical->staff_name }}" name="staff_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualification with Specialisation</label>
                            <input type="text" value="{{ $medical->staff_qualification }}" name="staff_qualification" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience in years related to present work</label>
                            <input type="text" value="{{ $medical->staff_experience }}" name="staff_experience" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant Training</label>
                            <input type="text" value="{{ $medical->staff_relevant }}" name="staff_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Authorised for which specific area of testing</label>
                            <input type="text" value="{{ $medical->staff_authorised }}" name="staff_authorised" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label> Specimen Signature</label>
                            <input type="text" value="{{ $medical->staff_specimen }}" name="staff_specimen" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $medical->staff_quality_name }}" name="staff_quality_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label> Qualification with Specialisation</label>
                            <input type="text" value="{{ $medical->staff_quality_qualifications }}" name="staff_quality_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label> Experience in years related to present work</label>
                            <input type="text" value="{{ $medical->staff_quality_experience }}" name="staff_quality_experience" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label> Relevant Training</label>
                            <input type="text" value="{{ $medical->staff_quality_training }}" name="staff_quality_training" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label> Specimen Signature</label>
                            <input type="text" value="{{ $medical->staff_quality_specimen }}" name="staff_quality_specimen" readonly class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $medical->staff_name_section }}" name="staff_name_section" readonly class="form-control">
                        ...
                        <div class="row">
                            <div class="form-group d-flex">
                                <input type="text" value="{{ $medical->staff_section_name }}" name="staff_section_name" readonly class="form-control col-2">
                                <input type="text" value="{{ $medical->staff_section_qualification }}" name="staff_section_qualification" readonly class="form-control col-2">
                                <input type="text" value="{{ $medical->staff_section_experience }}" name="staff_section_experience" readonly class="form-control col-2">
                                <input type="text" value="{{ $medical->staff_section_relevant }}" name="staff_section_relevant" readonly class="form-control col-2">
                                <input type="text" value="{{ $medical->staff_section_authorised }}" name="staff_section_authorised" readonly class="form-control col-2">
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="scop_sample_type" readonly class="form-control">{{ $medical->scop_sample_type }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Types of test/Properties measured</label>
                            <textarea name="scop_types" readonly class="form-control">{{ $medical->scop_types }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Range of measurement</label>
                            <textarea name="scop_range" readonly class="form-control">{{ $medical->scop_range }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Minimum detection limit</label>
                            <textarea name="scop_detection" readonly class="form-control">{{ $medical->scop_detection }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Uncertainty of Measurement (where applicable)
                                ( + )
                            </label>
                            <textarea name="scop_uncertainty" readonly class="form-control">{{ $medical->scop_uncertainty }}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Standard specification/Techniques/equipment used</label>
                            <textarea name="scop_standard" readonly class="form-control">{{ $medical->scop_standard }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>*Quality Control Measures</label>
                            <textarea name="scop_quality" readonly class="form-control">{{ $medical->scop_quality }}</textarea>
                        </div>
                        <div class="form-group">
                            <h6>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="scop_major_name" readonly class="form-control">{{ $medical->scop_major_name }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Model/Type/year of make</label>
                            <textarea name="scop_major_model" readonly class="form-control">{{ $medical->scop_major_model }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Working Range/capacity of equipment</label>
                            <textarea name="scop_major_working" readonly class="form-control">{{ $medical->scop_major_working }}</textarea>
                            <div class="form-group">
                                <label>Minimum detection limit</label>
                                <textarea name="scop_major_minimum" readonly class="form-control">{{ $medical->scop_major_minimum }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Last date of calibration</label>
                                <textarea name="scop_major_lastdate" readonly class="form-control">{{ $medical->scop_major_lastdate }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Calibration due date</label>
                                <textarea name="scop_major_duedate" readonly class="form-control">{{ $medical->scop_major_duedate }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Test for which used and other relevant information</label>
                                <textarea name="scop_major_test" readonly class="form-control">{{ $medical->scop_major_test }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Name of Equipment</label>
                                <textarea name="scop_reference_name" readonly class="form-control">{{ $medical->scop_reference_name }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Source/Supplier’s name</label>
                                <textarea name="scop_reference_source" readonly class="form-control">{{ $medical->scop_reference_source }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Date of expiry/validity</label>
                                <textarea name="scop_reference_date_ex" readonly class="form-control">{{ $medical->scop_reference_date_ex }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Traceability</label>
                                <textarea name="scop_reference_traceability" readonly class="form-control">{{ $medical->scop_reference_traceability }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Purpose of use</label>
                                <textarea name="scop_reference_purpose" readonly class="form-control">{{ $medical->scop_reference_purpose }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="scop_proficiency_product" readonly class="form-control">{{ $medical->scop_proficiency_product }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Details of Test(s)/examination</label>
                                <textarea name="scop_proficiency_details" readonly class="form-control">{{ $medical->scop_proficiency_details }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Date of testing/examination</label>
                                <textarea name="scop_proficiency_date" readonly class="form-control">{{ $medical->scop_proficiency_date }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Organizing body</label>
                                <textarea name="scop_proficiency_organizing" readonly class="form-control">{{ $medical->scop_proficiency_organizing }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Performance in term of Z -score or any other criteria</label>
                                <textarea name="scop_proficiency_performance" readonly class="form-control">{{ $medical->scop_proficiency_performance }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Corrective actions taken (if readonly)</label>
                                <textarea name="scop_proficiency_corrective" readonly class="form-control">{{ $medical->scop_proficiency_corrective }}</textarea>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <textarea name="quality_fully_comment" readonly class="form-control">{{ $medical->quality_fully_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea readonly name="quality_record_comment" class="form-control">{{ $medical->quality_record_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea readonly name="quality_adequate_comment" class="form-control">{{ $medical->quality_adequate_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea readonly name="quality_procedures_comment" class="form-control">{{ $medical->quality_procedures_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea readonly name="quality_internal_comment" class="form-control">{{ $medical->quality_internal_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea readonly name="quality_pnac_comment" class="form-control">{{ $medical->quality_pnac_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea readonly name="quality_other_comment" class="form-control">{{ $medical->quality_other_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea readolny name="quality_perform_comment" class="form-control">{{ $medical->quality_perform_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea readolny name="quality_identified_comment" class="form-control">{{ $medical->quality_identified_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea readolny name="quality_incorporate_comment" class="form-control">{{ $medical->quality_incorporate_comment }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea readolny name="quality_compliance_specific" class="form-control">{{ $medical->quality_compliance_specific }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Area of non-compliance </label>
                            <textarea readolny name="quality_compliance_area" class="form-control">{{ $medical->quality_compliance_area }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Rectified by (date)</label>
                            <input type="date" name="quality_rectified" value="{{ $medical->quality_rectified }}" readonly class="form-control">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea readolny name="approvals_name" class="form-control">{{ $medical->approvals_name }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Scope of accreditation/approval and number of certificate (if any)</label>
                            <textarea readolny name="approvals_scope" class="form-control">{{ $medical->approvals_scope }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Start</label>
                                <input type="date" name="approvals_start_date" value="{{ $medical->approvals_start_date }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Expiry Date</label>
                                <input type="date" name="approvals_end_date" value="{{ $medical->approvals_end_date }}" readonly class="form-control">
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <label>Other (Please describe)</label>
                            <input type="text" value="{{ $medical->declaration_moleculary }}" readonly name="declaration_moleculary" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Date</label>
                                <input type="date" name="date" value="{{ $medical->date }}" readonly class="form-control">
                            </div>
                        </div>
