                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $personnel->name_address }}" name="name_address" readonly class="form-control">
                        </div>

                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{ $personnel->postcode }}" name="postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $personnel->tel }}" name="tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $personnel->fax }}" name="fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>E-mail</label>
                                <input type="email" value="{{ $personnel->email }}" name="email" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Website</label>
                                <input type="text" value="{{ $personnel->website }}" name="website" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $personnel->contact_name }}" name="contact_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Designation:</label>
                            <input type="text" value="{{ $personnel->designation }}" name="designation" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address:</label>
                            <input type="text" value="{{ $personnel->person_address }}" name="person_address" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{ $personnel->person_postcode }}" name="person_postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $personnel->person_tel }}" name="person_tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Call No</label>
                                <input type="text" value="{{ $personnel->person_cal_no }}" name="person_cal_no" readonly class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Fax</label>
                                <input type="text" value="{{ $personnel->person_fax }}" name="person_fax" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>E-mail</label>
                                <input type="email" value="{{ $personnel->person_email }}" name="person_email" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group col-6">
                            <label>Details of sub-offices in other cities</label>
                            <input type="text" value="{{ $personnel->person_detail }}" name="person_detail" readonly class="form-control">
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" value="{{ $personnel->selves_title }}" name="selves_title" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>name</label>
                            <input type="text" value="{{ $personnel->selves_name }}" name="selves_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Position</label>
                            <input type="text" value="{{ $personnel->selves_position }}" name="selves_position" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $personnel->selves_parent_organization }}" name="selves_parent_organization" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $personnel->selves_parent_address }}" name="selves_parent_address" readonly class="form-control">
                        </div>

                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{ $personnel->selves_postcode }}" name="selves_postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $personnel->selves_tel }}" name="selves_tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $personnel->selves_fax }}" name="selves_fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $personnel->selves_other_describe }}" name="selves_other_describe" readonly class="form-control">
                        </div>
                        <div class="form-group">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $personnel->staff_chief_name }}" name="staff_chief_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $personnel->staff_chief_qualifications }}" name="staff_chief_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $personnel->staff_chief_relevant }}" name="staff_chief_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $personnel->staff_chief_exp }}" name="staff_chief_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $personnel->staff_quality_name }}" name="staff_quality_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $personnel->staff_quality_qualifications }}" name="staff_quality_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $personnel->staff_quality_relevant }}" name="staff_quality_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $personnel->staff_quality_exp }}" name="staff_quality_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $personnel->staff_manage_name }}" name="staff_manage_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $personnel->staff_manage_qualifications }}" name="staff_manage_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $personnel->staff_manage_relevant }}" name="staff_manage_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $personnel->staff_manage_exp }}" name="staff_manage_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <h6>A. Experts (if readonly please attach extra sheets and Annex)</h6>
                        </div>

                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $personnel->staff_expert_name }}" name="staff_expert_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $personnel->staff_expert_qualifications }}" name="staff_expert_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Auditing Field</label>
                            <input type="text" value="{{ $personnel->staff_expert_field }}" name="staff_expert_field" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit Experience</label>
                            <input type="text" value="{{ $personnel->staff_expert_exp }}" name="staff_expert_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <h6>B. Sub-contracted/Freelance/Empanelled Experts (if readonly please attach extra sheets)
                            </h6>
                        </div>

                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $personnel->staff_sub_name }}" name="staff_sub_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $personnel->staff_sub_qualifications }}" name="staff_sub_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Auditing Field</label>
                            <input type="text" value="{{ $personnel->staff_sub_field }}" name="staff_sub_field" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit Experience</label>
                            <input type="text" value="{{ $personnel->staff_sub_exp }}" name="staff_sub_exp" readonly class="form-control">
                        </div>
        ...
        <div class="row section-form personnel-certification-section-form" id="ScopeApplication-PersonnelCertification-form">
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-header">
                            <h6>3.1 List all the sectors/areas for which accreditation readonly. e.g.,</h6>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <textarea name="quality_org_manual_comment" readonly class="form-control">{{ $personnel->quality_org_manual_comment }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <textarea readonly name="quality_org_policy_comment" class="form-control">{{ $personnel->quality_org_policy_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_org_doc_comment" class="form-control">{{ $personnel->quality_org_doc_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_org_contain_comment" class="form-control">{{ $personnel->quality_org_contain_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_org_cbp_comment" class="form-control">{{ $personnel->quality_org_cbp_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_org_cb_comment" class="form-control">{{ $personnel->quality_org_cb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_org_impartiality_comment" class="form-control">{{ $personnel->quality_org_impartiality_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_org_necessary_comment" class="form-control">{{ $personnel->quality_org_necessary_comment }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_res_cbp_comment" class="form-control">{{ $personnel->quality_res_cbp_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_res_defined_comment" class="form-control">{{ $personnel->quality_res_defined_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_res_declared_comment" class="form-control">{{ $personnel->quality_res_declared_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_res_out_comment" class="form-control">{{ $personnel->quality_res_out_comment }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_record_cbp_comment" class="form-control">{{ $personnel->quality_record_cbp_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_record_maintain_comment" class="form-control">{{ $personnel->quality_record_maintain_comment }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_certified_cbp_comment" class="form-control">{{ $personnel->quality_certified_cbp_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_certified_process_comment" class="form-control">{{ $personnel->quality_certified_process_comment }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_req_cbp_comment" class="form-control">{{ $personnel->quality_req_cbp_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_req_complete_comment" class="form-control">{{ $personnel->quality_req_complete_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_req_examinat_comment" class="form-control">{{ $personnel-> }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_req_decision_comment" class="form-control">{{ $personnel->quality_req_decision_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_req_suspend_comment" class="form-control">{{ $personnel->quality_req_suspend_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_req_policy_comment" class="form-control">{{ $personnel->quality_req_policy_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_req_appeals_comment" class="form-control">{{ $personnel->quality_req_appeals_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_manage_cbp_comment" class="form-control">{{ $personnel->quality_manage_cbp_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_manage_fully_comment" class="form-control">{{ $personnel->quality_manage_fully_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_manage_record_comment" class="form-control">{{ $personnel->quality_manage_record_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_manage_pcb_comment" class="form-control">{{ $personnel->quality_manage_pcb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_manage_proced_comment" class="form-control">{{ $personnel->quality_manage_proced_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_manage_correct_comment" class="form-control">{{ $personnel->quality_manage_correct_comment }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $personnel->quality_non_compliance }}" readonly name="quality_non_compliance" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="" class="col-3">Rectified by (date)</label>
                            <input type="date" value="{{ $personnel->quality_rectified_date }}" readonly name="quality_rectified_date" class="form-control">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea readonly name="approvals_name" class="form-control">{{ $personnel->approvals_name }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Scope of accreditation/approval and number of certificate (if any)</label>
                            <textarea readonly name="approvals_scope" class="form-control">{{ $personnel->approvals_scope }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Start</label>
                                <input type="date" value="{{ $personnel->approvals_start_date }}" readonly name="approvals_start_date" class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Expiry Date</label>
                                <input type="date" value="{{ $personnel->approvals_end_date }}" readonly name="approvals_end_date" class="form-control">
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-4">
                                <label>Date</label>
                                <input type="date" name="declaration_date" value="{{ $personnel->declaration_date }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Name</label>
                                <input type="text" value="{{ $personnel->declaration_name }}" readonly name="declaration_name" class="form-control">
                            </div>
                        </div>
