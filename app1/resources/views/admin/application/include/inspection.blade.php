                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="inspection_body" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="email" name="sub_offices" required class="form-control">
                        </div>
                        <div class="form-group col-6">
                            <label>offices in other cities</label>
                            <input type="email" name="offices_cities" required class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="chack_Completely">
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="chack_copies">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" name="organized_title" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>name</label>
                            <input type="text" name="organized_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Position</label>
                            <input type="text" name="organized_position" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="organized_parent_organization" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relationship with Parent Organization</label>
                            <input type="text" name="organized_parent_relationship" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" name="organized_parent_address" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Postcode</label>
                            <input type="text" name="organized_parent_postcode" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Tel</label>
                            <input type="text" name="organized_parent_tel" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Fax</label>
                            <input type="text" name="organized_parent_fax" required class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="organized_invoicing_organization" required class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" name="organized_invoicing_address" required class="form-control">
                        </div>

                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" name="organized_invoicing_postcode" required class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" name="organized_invoicing_tel" required class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" name="organized_invoicing_fax" required class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="organized_legal_status">

                        </div>
                        <div class="form-group">
                            <label>1.6 Does your organisation carry out inspection work outside Pakistan?</label>
                            <input type="radio" name="organized_inspection" value="Yes"> Yes
                            <input type="radio" name="organized_inspection" value="No"> No
                        </div>


                        <div class="form-group col-6">
                            <label>(if yes, please specify the types of inspection works and the countries in which they are carried out)</label>
                            <input type="text" name="organized_specify" class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="radio" name="organized_activity" value="Yes"> Yes
                            <input type="radio" name="organized_activity" value="No"> No
                        </div>
                        <div class="form-group">
                            <label for="">describe the main activities of the company</label>
                            <input type="text" name="organized_describe" class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="radio" name="organized_body_type" value="Type A"> Type A:
                            <input type="radio" name="organized_body_type" value="Type B"> Type B:
                            <input type="radio" name="organized_body_type" value="Type C"> Type C:
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="organized_other_name" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Scope of Accreditation</label>
                            <input type="text" name="organized_other_scope" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Period of Accreditation</label>
                            <input type="text" name="organized_other_period" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="organized_consult_name" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Organisation(if any)</label>
                            <input type="text" name="organized_consult_Org" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Address</label>
                            <input type="text" name="organized_consult_address" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Postcode</label>
                            <input type="text" name="organized_consult_postcode" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Tel</label>
                            <input type="text" name="organized_consult_tel" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Fax</label>
                            <input type="text" name="organized_consult_fax" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">E-mail</label>
                            <input type="email" name="organized_consult_email" class="form-control">
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="staff_inspect_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" name="staff_inspect_qualifications" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Auditing Field</label>
                            <input type="text" name="staff_inspect_auditing" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit  Experience</label>
                            <input type="text" name="staff_inspect_exp" required class="form-control">
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>
                                ...
                                <input type="text" name="scop_inspect_des" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>
                            ...
                            <input type="text" name="scop_range" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>
                            ...
                            <input type="text" name="scop_method" required class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="scop_economic_b" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Date of Last Calibration</label>
                            <input type="date" name="scop_last_calib" required class="form-control">
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-4">
                                <input type="checkbox" name="declaration_type_a">
                            </div>
                            <div class="form-group col-4">
                                <input type="checkbox" name="declaration_type_b">
                            </div>
                            <div class="form-group col-4">
                                <input type="checkbox" name="declaration_type_c">
                            </div>
                        </div>
