            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="chack_chemical">
                            <label for="">Chemical analysis</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="chack_textile">
                            <label for="">Textile testing</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="chack_environment">
                            <label for="">Environmental analysis</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="chack_biological">
                            <label for="">Biological testing</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="chack_clinical">
                            <label for="">Clinical/Medical testing</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="chack_dimensional">
                            <label for="">Dimensional measurement and inspection</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="chack_mechanical">
                            <label for="">Dimensional, mechanical, thermodynamic, electrical calibration</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="chack_materials">
                            <label for="">Materials testing</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="chack_metallurgical">
                            <label for="">Metallurgical testing </label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="chack_others">
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="chack_complete">
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="chack_relevant">
                            <label for="">List of all relevant experts and subcontractors, if applicable</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="chack_suppliers">
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="chack_report">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <input type="checkbox" name="selves_own_org">
                                <label>Own organisation</label>
                            </div>
                            <div class="form-group col-6">
                                <input type="checkbox" name="selves_other_org">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="staff_exp" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="staff_coordinator_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" name="staff_coordinator_qualifications" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" name="staff_coordinator_relevant" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" name="staff_coordinator_exp" required class="form-control">
                        </div>
                        <div class="form-group">
                            <h6>C.	Statistian</h6>
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="staff_statistian_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" name="staff_statistian_qualifications" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" name="staff_statistian_relevant" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" name="staff_statistian_exp" required class="form-control">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="scop_parameter" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Proficiency Testing Items/ Materials/ Matrix/Products (eg Reinforced Steel Bars)</label>
                            <input type="text" name="scop_testing" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Number of Proficiency Test Item Round (e.g 5 nos)</label>
                            <input type="text" name="scop_round" required class="form-control">
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="declaration_applicant">
