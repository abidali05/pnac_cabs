                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Product</label>
                            <input type="text" value="{{ $product->product }}" name="product" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Certification Body (PCB),</label>
                            <input type="text" value="{{ $product->certification_body }}" name="certification_body" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Name and Address</label>
                            <input type="text" value="{{ $product->name_address }}" name="name_address" required class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{ $product->postcode }}" name="postcode" required class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $product->tel }}" name="tel" required class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $product->fax }}" name="fax" required class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>E-mail</label>
                                <input type="email" value="{{ $product->email }}" name="email" required class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Website</label>
                                <input type="text" value="{{ $product->website }}" name="website" required class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $product->contact_name }}" name="contact_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Designation:</label>
                            <input type="text" value="{{ $product->designation }}" name="designation" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address:</label>
                            <input type="text" value="{{ $product->person_address }}" name="person_address" required class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Postcode</label>
                                <input type="text" value="{{ $product->person_postcode }}" name="person_postcode" required class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Tel</label>
                                <input type="text" value="{{ $product->person_tel }}" name="person_tel" required class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Fax</label>
                                <input type="text" value="{{ $product->person_fax }}" name="person_fax" required class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>E-mail</label>
                                <input type="email" value="{{ $product->person_email }}" name="person_email" required class="form-control">
                            </div>
                        </div>
                        <div class="form-group col-6">
                            <label>Details of sub-offices/marketing offices in other cities</label>
                            <input type="text" value="{{ $product->person_detail }}" name="person_detail" required class="form-control">
                        </div>
        ...
        <div class="row section-form product-certification-section-form" id="AboutYourselves-ProductCertification-form">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" value="{{ $product->selves_title }}" name="selves_title" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>name</label>
                            <input type="text" value="{{ $product->selves_name }}" name="selves_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Position</label>
                            <input type="text" value="{{ $product->selves_position }}" name="selves_position" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $product->selves_parent_organization }}" name="selves_parent_organization" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relationship with parent organization</label>
                            <input type="text" value="{{ $product->selves_parent_relationship }}" name="selves_parent_relationship" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $product->selves_parent_address }}" name="selves_parent_address" required class="form-control">
                        </div>

                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{ $product->selves_postcode }}" name="selves_postcode" required class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $product->selves_tel }}" name="selves_tel" required class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $product->selves_fax }}" name="selves_fax" required class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $product->selves_invoicing_organization }}" name="selves_invoicing_organization" required class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $product->selves_invoicing_address }}" name="selves_invoicing_address" required class="form-control">
                        </div>

                        <div class="row">
                            <div class="form-group col-3">
                                <label>Postcode</label>
                                <input type="text" value="{{ $product->selves_invoicing_postcode }}" name="selves_invoicing_postcode" required class="form-control">
                            </div>
                            <div class="form-group col-3">
                                <label>Tel</label>
                                <input type="text" value="{{ $product->selves_invoicing_tel }}" name="selves_invoicing_tel" required class="form-control">
                            </div>
                            <div class="form-group col-3">
                                <label>Fax</label>
                                <input type="text" value="{{ $product->selves_invoicing_fax }}" name="selves_invoicing_fax" required class="form-control">
                            </div>
                            <div class="form-group col-3">
                                <label>E-mail</label>
                                <input type="email" value="{{ $product->selves_invoicing_email }}" name="selves_invoicing_email" required class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $product->selves_other_describe }}" name="selves_other_describe" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $product->selves_consult_name }}" name="selves_consult_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Organization(if any)</label>
                            <input type="text" value="{{ $product->selves_consult_organization }}" name="selves_consult_organization" required class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $product->selves_consult_address }}" name="selves_consult_address" required class="form-control">
                        </div>

                        <div class="row">
                            <div class="form-group col-3">
                                <label>Postcode</label>
                                <input type="text" value="{{ $product->selves_consult_postcode }}" name="selves_consult_postcode" required class="form-control">
                            </div>
                            <div class="form-group col-3">
                                <label>Tel</label>
                                <input type="text" value="{{ $product->selves_consult_tel }}" name="selves_consult_tel" required class="form-control">
                            </div>
                            <div class="form-group col-3">
                                <label>Fax</label>
                                <input type="text" value="{{ $product->selves_consult_fax }}" name="selves_consult_fax" required class="form-control">
                            </div>
                            <div class="form-group col-3">
                                <label>E-mail</label>
                                <input type="email" value="{{ $product->selves_consult_email }}" name="selves_consult_email" required class="form-control">
                            </div>
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $product->staff_chief_name }}" name="staff_chief_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $product->staff_chief_qualifications }}" name="staff_chief_qualifications" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $product->staff_chief_relevant }}" name="staff_chief_relevant" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $product->staff_chief_exp }}" name="staff_chief_exp" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $product->staff_quality_name }}" name="staff_quality_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $product->staff_quality_qualifications }}" name="staff_quality_qualifications" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $product->staff_quality_relevant }}" name="staff_quality_relevant" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $product->staff_quality_exp }}" name="staff_quality_exp" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $product->staff_manage_name }}" name="staff_manage_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $product->staff_manage_qualifications }}" name="staff_manage_qualifications" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $product->staff_manage_relevant }}" name="staff_manage_relevant" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $product->staff_manage_exp }}" name="staff_manage_exp" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $product->staff_auditor_name }}" name="staff_auditor_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $product->staff_auditor_qualifications }}" name="staff_auditor_qualifications" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Auditing Field</label>
                            <input type="text" value="{{ $product->staff_auditor_field }}" name="staff_auditor_field" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit  Experience</label>
                            <input type="text" value="{{ $product->staff_auditor_exp }}" name="staff_auditor_exp" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $product->staff_list_name }}" name="staff_list_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $product->staff_list_qualifications }}" name="staff_list_qualifications" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Auditing Field</label>
                            <input type="text" value="{{ $product->staff_list_field }}" name="staff_list_field" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit  Experience</label>
                            <input type="text" value="{{ $product->staff_list_exp }}" name="staff_list_exp" required class="form-control">
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Product</label>
                            <input type="text" value="{{ $product->scop_product }}" name="scop_product" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Type of Scheme according to ISO/IEC 17067/ GLOBALGAP certification schemes</label>
                            <input type="text" value="{{ $product->scop_according }}" name="scop_according" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Standards</label>
                            <input type="text" value="{{ $product->scop_standard }}" name="scop_standard" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Countries where certificates are to be issued </label>
                            <input type="text" value="{{ $product->scop_countries }}" name="scop_countries" required class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $product->scop_equipment }}" name="scop_equipment" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Date of last calibration</label>
                            <input type="text" value="{{ $product->scop_last_date }}" name="scop_last_date" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Date of next calibration</label>
                            <input type="text" value="{{ $product->scop_next_date }}" name="scop_next_date" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Calibration Organization</label>
                            <input type="text" value="{{ $product->scop_calibration }}" name="scop_calibration" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Details of in-house Checks performed</label>
                            <input type="text" value="{{ $product->scop_details }}" name="scop_details" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Tests for which used and other comments</label>
                            <input type="text" value="{{ $product->scop_comments }}" name="scop_comments" required class="form-control">
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <textarea name="org_quality_comment" required class="form-control">{{ $product->org_quality_comment }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <textarea name="org_policy_comment_comment" class="form-control">{{ $product->org_policy_comment_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="org_doc_comment" class="form-control">{{ $product->org_doc_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="org_contain_comment" class="form-control">{{ $product->org_contain_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="org_qmr_comment" class="form-control">{{ $product->org_qmr_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="org_pcb_comment" class="form-control">{{ $product->org_pcb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="org_sufficient_comment" class="form-control">{{ $product->org_sufficient_comment }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="quality_doc_comment" class="form-control">{{ $product->quality_doc_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="quality_frequency_comment" class="form-control">{{ $product->quality_frequency_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="quality_record_comment" class="form-control">{{ $product->quality_record_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="quality_pcb_comment" class="form-control">{{ $product->quality_pcb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="quality_reviews_comment" class="form-control">{{ $product->quality_reviews_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="certification_quality_comment" class="form-control">{{ $product->certification_quality_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="certification_appropriate_comment" class="form-control">{{ $product->certification_appropriate_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="certification_doc_comment" class="form-control">{{ $product->certification_doc_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <h5>D. 	Procedures</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="procedures_fully_comment" class="form-control">{{ $product->procedures_fully_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="procedures_doc_comment" class="form-control">{{ $product->procedures_doc_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <h5>E. 	Records </h5>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="record_system_comment" class="form-control">{{ $product->record_system_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="record_arrange_comment" class="form-control">{{ $product->record_arrange_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="record_period_comment" class="form-control">{{ $product->record_period_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="complaint_pcb_comment" class="form-control">{{ $product->complaint_pcb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="complaint_record_comment" class="form-control">{{ $product->complaint_record_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="sub_pcb_comment" class="form-control">{{ $product->sub_pcb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="sub_register_comment" class="form-control">{{ $product->sub_register_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="outside_pcb_comment" class="form-control">{{ $product->outside_pcb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="outside_record_comment" class="form-control">{{ $product->outside_record_comment }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" value="{{ $product->rectified_date }}" name="rectified_date" class="form-control">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="approvals_name" class="form-control">{{ $product->approvals_name }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Scope of accreditation/approval and number of certificate (if any)</label>
                            <textarea name="approvals_scope" class="form-control">{{ $product->approvals_scope }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Start</label>
                                <input type="date" name="approvals_start_date" value="{{ $product->approvals_start_date }}" class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Expiry Date</label>
                                <input type="date" name="approvals_end_date" value="{{ $product->approvals_end_date }}" class="form-control">
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Date</label>
                                <input type="date" name="declaration_date" value="{{ $product->declaration_date }}" class="form-control">
                            </div>
                        </div>
