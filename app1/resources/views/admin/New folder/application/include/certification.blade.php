            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" name="general_address" required class="form-control">
                        </div>
                        <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="sub_offices" required class="form-control">
                        </div>
                        <div class="form-group col-6">
                            <label>offices in other cities</label>
                            <input type="text" name="offices_cities" required class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="new_accreditation">
                            <label for="">New accreditation as a certification body for;</label>
                        </div>
                        <div class="row">
                            <div class="form-group col-2">
                                <input type="checkbox" name="qms">
                                <label for="">QMS</label>
                            </div>
                            <div class="form-group col-2">
                            ...
                            <div class="form-group col-2">
                                <input type="checkbox" name="FSMS">
                                <label for="">FSMS</label>
                            </div>
                            <div class="form-group col-2">
                                <input type="checkbox" name="ISO_45001">
                                <label for="">ISO 45001</label>
                            </div>
                            <div class="form-group col-2">
                                <input type="checkbox" name="ISO_13485">
                                <label for="">ISO 13485</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="other_management">
                            <label for="">Other type of Management System _______(under the scope of ISO/IEC 17021-1)</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="extension_scope">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <input type="checkbox" name="chack_quality_manual">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <input type="checkbox" name="chack_list_staff">
                                <label for="">List of staff</label>
                            </div>
                            <div class="form-group col-6">
                                <input type="checkbox" name="chack_list_certified">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <input type="checkbox" name="chack_proof">
                                <label for="">Proof of legal entity</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="chack_filled_form">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <input type="checkbox" name="selves_tech">
                                <label>Part of learned/tech institution</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <input type="checkbox" name="selves_nationalised">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="selves_main_activities" required class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Name</label>
                                <input type="text" name="selves_consultant_name" class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Organisation(if any)</label>
                                <input type="text" name="selves_consultant_Org" class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Address</label>
                                <input type="text" name="selves_consultant_address" class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Postcode</label>
                                <input type="text" name="selves_consultant_postcode" class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Tel</label>
                                <input type="text" name="selves_consultant_tel" class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Fax</label>
                                <input type="text" name="selves_consultant_fax" class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>E-mail</label>
                                <input type="email" name="selves_consultant_email" class="form-control">
                            </div>
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="staff_manag_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" name="staff_manag_qualifications" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" name="staff_manag_relevant" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" name="staff_manag_exp" required class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="staff_assessor_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" name="staff_assessor_qualifications" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Auditing Field</label>
                            <input type="text" name="staff_assessor_auditing" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit Experience</label>
                            <input type="text" name="staff_assessor_exp" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Auditing Field</label>
                            <input type="text" name="staff_sub_auditing" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit Experience</label>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="scop_technical_a" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label>IAF code</label>
                            <textarea name="scop_iaf_a" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Description of economic sector/activity, according to IAF ID1</label>
                            <textarea name="scop_economic_a" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <h5>
                        ...
                        <div class="form-group">
                            <label>Technical Cluster</label>
                            <textarea name="scop_technical_b" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label>IAF code</label>
                            <textarea name="scop_iaf_b" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Description of economic sector/activity, according to IAF ID1</label>
                            <textarea name="scop_economic_b" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <h5>
                        ...
                        <div class="form-group">
                            <label>Technical Cluster</label>
                            <textarea name="scop_technical_c" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label>IAF code</label>
                            <textarea name="scop_iaf_c" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Description of economic sector/activity, according to IAF ID1</label>
                            <textarea name="scop_economic_c" required class="form-control"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <label>Cluster</label>
                            <input name="scop_cluster" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Category</label>
                            <input name="scop_category" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Sub-Category</label>
                            <input name="scop_subcategory" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Activities</label>
                            <input name="scop_activity" required class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="scop_main_tech" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Technical Areas</label>
                            <input name="scop_areas" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Product Categories Covered by the Technical Areas</label>
                            <input name="scop_product" required class="form-control">
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <input type="radio" name="quality_consider" value="Yes">
                                <label for="" class="col-3">Yes</label>
                                <input type="radio" name="quality_consider" value="No">
                                <label for="">No</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="quality_noncompliance" required class="form-control">

                        </div>
                        <div class="form-group">
                            <label for="">Rectified by (date)</label>
                            <input type="date" name="quality_rect_date" required class="form-control">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="quality_name" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Scope of accreditation/approval and number of certificate (if any)</label>
                            <input type="text" name="quality_accreditation" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="quality_start_date" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Expiry Date</label>
                            <input type="date" name="quality_expiry_date" required class="form-control">
                        </div>
