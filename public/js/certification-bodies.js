document.addEventListener("DOMContentLoaded", function () {
    document
        .querySelectorAll(".cb-application-form .js-add-row")
    ...
    function toggleOther() {
        const checked = document.querySelector(
            '.cb-other-toggle[value="Other"]',
        )?.checked;
        document
            .querySelectorAll(".cb-other-wrap")
            .forEach((el) => el.classList.toggle("d-none", !checked));
    }

    function toggleOwnership() {
        const show =
            document.querySelector(".cb-ownership-select")?.value === "Other";
        document
    ...
    function toggleActivity() {
        const show =
            document.querySelector(".cb-main-activity-select")?.value === "no";
        document
    ...
    function toggleQuality() {
        const value = document.querySelector(
            ".cb-quality-toggle:checked",
        )?.value;
        document
            .querySelectorAll(".cb-non-compliance-wrap")
            .forEach((el) => el.classList.toggle("d-none", value !== "no"));
    }
