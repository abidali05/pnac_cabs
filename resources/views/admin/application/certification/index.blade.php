        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card" id="GeneralTable">
                    ...
                    <form action="{{ route('application.store.certification') }}" id="Part1Form" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <input type="text" name="scheme" value="{{ $scheme_name }}" readonly class="form-control">
...
@endforelse
                    ...
                    <div class="card-body row mb-3">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-4">
                                    ...
                                    <button class="card-link btn btn-warning" data-type="Testing" data-bs-toggle="modal" data-bs-target="#scopeModal">Add Testing</button>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-3">
                                    ...
                                    <button class="card-link btn btn-warning" data-type="Calibration" data-bs-toggle="modal" data-bs-target="#scopeModal">Add Calibration</button>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-4">
                                    ...
                                    <button class="card-link btn btn-warning" data-type="ISO9001" data-bs-toggle="modal" data-bs-target="#scopeModal">Add ISO 9001:2025</button>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-4">
                                    ...
                                    <button class="card-link btn btn-warning px-4" data-type="ISO14001" data-bs-toggle="modal" data-bs-target="#scopeModal">Add ISO 14001</button>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-4">
                                    ...
                                    <button class="card-link btn btn-warning px-4" data-type="ISO45001" data-bs-toggle="modal" data-bs-target="#scopeModal">Add ISO 45001</button>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-4">
                                    ...
                                    <button class="card-link btn btn-warning px-4" data-type="ISO13485" data-bs-toggle="modal" data-bs-target="#scopeModal">Add ISO 13485</button>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-4">
                                    ...
                                    <button class="card-link btn btn-warning px-4" data-type="ISO22000" data-bs-toggle="modal" data-bs-target="#scopeModal">Add ISO 22000</button>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-4">
                                    <h5 class="card-subtitle mb-3">Scope of Application</h5>
                                    <h6 class="card-title font-weight-bold text-muted">Medical Laboratories</h6>

                                    <button class="card-link btn btn-warning px-4" data-bs-toggle="modal" data-bs-target="#scopeModal">Add Medical Laboratories</button>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-4">
                                    ...
                                    <button class="card-link btn btn-warning px-4" data-bs-toggle="modal" data-bs-target="#scopeModal">Add Inspection Bodies</button>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-4">
                                    ...
                                    <a class="card-link btn btn-warning px-4 text-white" data-bs-toggle="modal" data-bs-target="#scopeModal">Add Halal Certification Bodies</a>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-4">
                                    ...
                                    <button class="card-link btn btn-warning px-4" data-bs-toggle="modal" data-bs-target="#scopeModal">Add Proficiency Testing Provider</button>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-4">
                                    ...
                                    <button class="card-link btn btn-warning px-4" data-bs-toggle="modal" data-bs-target="#scopeModal">Add Product Certification Bodies</button>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center justify-content-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-4">
                                    <h5 class="card-subtitle mb-3">Scope of Application</h5>
                                    <h6 class="card-subtitle mb-3 text-muted">Personnel Certification Bodies</h6>
                                    <button class="card-link btn btn-warning" data-bs-toggle="modal" data-bs-target="#scopeModal">Add Personnel Certification Bodies</button>
                ...
                <div class="card" id="DeclarationTable">
                    ...
                    <form id="declarationForm" action="{{ route('application.store.certification') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-12 form-group">
                                <select name="testing_select" class="form-control">
                                    ...
                                    <option disabled>An extension in scope of existing accreditation for a:</option>
                            ...
                            <div class="form-group">
                                <p>
                                    7.2. The organisation/laboratory agrees to conform, upon accreditation, with PNAC requirements as detailed in the Agreement [F-01/04].
                                </p>
                            </div>
                            <div class="form-group">
                                <p>
                                    7.3. I enclose a cheque (payable to PNAC) for the Applicant fee of <input type="text" name="application_fee" value="{{ $declaration->application_fee ?? '' }}" @if (@$declaration->application_fee) ? readonly : '' @endif style="outline: none;">. I understand that this fee is non-refundable. (see Note below).
                                </p>
                            </div>
                            <div class="form-group">
                                <p>
                            ...
                            <div class="form-group">
                                <p>
                                    7.5. I declare that the information given in this form is correct to the best of my knowledge and belief
                                </p>
                            </div>
                            <div class="form-group">
                                <label for="">Browse Cheque File</label>
                                <input type="file" name="upload_file" class="form-control" accept="application/pdf, image/png, image/jpeg, image/jpg">
                                <strong class="text-danger">(Please uploaded Pdf,Jpeg,Jpg,PNG Formate document)</strong>
                            </div>
                            <div class="form-group">
                                <p>
                                    <b>Note-1:</b> PNAC will not process your application until it has received the documents and application fee.
                                </p>
                                {{-- <p>
                ...
                <div class="card" id="DeclarationTable">
                    ...
                    <form action="{{ route('application.store.certification') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <p>
                                    6.4. I enclose a cheque (payable to PNAC) for the Applicant fee of <input type="text" name="application_fee" value="{{ $declaration->application_fee ?? '' }}" style="outline: none;">. I understand that this fee is non-refundable. (see Note below).
                                </p>
                            </div>
                            <div class="form-group">
                                <p>
                ...
                <div class="card" id="DeclarationTable">
                    ...
                    <form action="{{ route('application.store.certification') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <p>
                                    6.1 The laboratory applies to PNAC for accreditation for (please tick appropriate boxes)
                                </p>
                            </div>
                            <div class="form-group">
                                <select name="testing_select" class="form-control">
                            ...
                            <div class="form-group">
                                <p>
                                    6.2. The organisation/laboratory agrees to conform, upon accreditation, with PNAC
                                    requirements as detailed in the Agreement [F-01/04].
                                </p>
                            </div>
                            <div class="form-group">
                                <p>
                                    6.3 The organisation/lab comply fully with ISO 15189: 2012 for accreditation of Medical testing laboratories.
                                </p>
                            </div>
                            <div class="form-group">
                                <p>
                                    6.4. I enclose a copy of Quality Manual and Quality Procedures (see Note below)
                                </p>
                            </div>
                            <div class="form-group">
                                <p>
                                    6.5 I understand PNAC policies and procedures for Assessment, surveillance and Re-assessment.
                                </p>
                            </div>
                            <div class="form-group">
                                <p>
                                    6.6. I enclose a cheque (payable to PNAC) for the Applicant fee of <input type="text" name="application_fee" value="{{ $declaration->application_fee ?? '' }}" style="outline: none;">. I understand that this fee is non-refundable. (see Note below).
                                </p>
                            </div>
                            <div class="form-group">
                                <p>
                            ...
                            <div class="form-group">
                                <p>
                                    6.8. I declare that the information given in this form is correct to the best of my knowledge and belief
                                </p>
                            </div>
                            <div class="form-group">
                                <label for="">Browse Cheque File</label>
                            ...
                            <div class="form-group">
                                <p>
                                    <b>Note:</b> PNAC will not process your application until it has received your Quality Manual and Quality & Technical Procedures and application fee.
                                </p>
                            </div>
                ...
                <div class="card" id="DeclarationTable">
                    ...
                    <form action="{{ route('application.store.certification') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <p>
                                    7.1 The Inspection Body applies for accreditation by PNAC as (please tick appropriate boxes)
                                </p>
                            </div>
                            <div class="form-group">
                                <select name="testing_select" class="form-control">
                            ...
                            <div class="form-group">
                                <p>
                                    7.4 The IB/organisation agrees to conform, upon accreditation with PNAC requirements as detailed in the Agreement [F-01/13].
                                </p>
                            </div>
                            <div class="form-group">
                                <p>
                            ...
                            <div class="form-group">
                                <p>
                                    7.7 I enclose a cheque (payable to PNAC) for the Applicant fee of <input type="text" name="application_fee" value="{{ $declaration->application_fee ?? '' }}" style="outline: none;">. I understand that this fee is non-refundable. (see Note below).
                                </p>
                            </div>
                            <div class="form-group">
                                <p>
                            ...
                            <div class="form-group">
                                <p>
                                    7.9 I declare that the information given in this form is correct to the best of my knowledge and belief.
                                </p>
                            </div>
                            <div class="form-group">
                                <label for="">Browse Cheque File</label>
                            ...
                            <div class="form-group">
                                <p>
                                    <b>Note:</b> PNAC will not process your application until it has reviewed your Quality Manual, procedures and received application fee.
                                </p>
                            </div>
                ...
                <div class="card" id="DeclarationTable">
                    ...
                    <form action="{{ route('application.store.certification') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <select name="testing_select" class="form-control">
                                    <option value="Halal(Scope as per Annex A)">Halal(Scope as per Annex A)</option>
                                    <option value="An extension in scope of existing accreditation">An extension in scope of existing accreditation</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>6.4. That I enclose a cheque (payable to PNAC) as the Applicant fee <input type="text" name="application_fee" value="{{ $declaration->application_fee ?? '' }}" style="outline: none;"> and I understand that this fee is non-refundable. (See Note below).</label>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <select name="testing_select" class="form-control">
                                    ...
                                    <option value="An extension in scope of existing accreditation for a">An extension in scope of existing accreditation for a</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>6.4. I enclose a cheque (payable to PNAC) for the Applicant fee of <input type="text" name="application_fee" value="{{ $declaration->application_fee ?? '' }}" style="outline: none;">.I understand that this fee is non-refundable. (see Note below). </label>
                            </div>
                            <div class="form-group">
                ...
                <div class="card" id="DeclarationTable">
                    ...
                    <form action="{{ route('application.store.certification') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <select name="testing_select" class="form-control">
                                    <option value="New Applicant as Product certification Body as per the requirements of ISO/IEC 17065">New Applicant as Product certification Body as per the requirements of ISO/IEC 17065</option>
                                    <option value="New Applicant as Product certification Body GLOBALGAP">New Applicant as Product certification Body GLOBALGAP</option>
                                    <option value="An extension in scope of existing accreditation">An extension in scope of existing accreditation</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <label>6.4. I enclose a cheque (payable to PNAC) as Application fee amounting Rs. <input type="text" name="application_fee" value="{{ $declaration->application_fee ?? '' }}" style="outline: none;">. I understand that this fee is non-refundable. (see Note below).</label>
                            </div>
                            <div class="form-group">
                ...
                <div class="card" id="DeclarationTable">
                    ...
                    <form action="{{ route('application.store.certification') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <select name="testing_select" class="form-control">
                                    <option value="New Applicant as Certification Body as per the requirements of ISO/IEC 17024">New Applicant as Certification Body as per the requirements of ISO/IEC 17024</option>
                                    <option value="An extension in scope of existing accreditation">An extension in scope of existing accreditation</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>6.4. I enclose a cheque (payable to PNAC) as Application fee amounting Rs.
                                    <input type="text" name="application_fee" value="{{ $declaration->application_fee ?? '' }}" style="outline: none;">. I understand that this fee is non-refundable. (see Note below).</label>
                            </div>
                            <div class="form-group">
                                <label>6.5. I understand manner in which the accreditation system functions.</label>
                            </div>
...
$(document).ready(function () {
    ...
    $('#main-technical').on('change', function () {
        ...
        $('#description-select').empty().append('<option selected disabled>Select Description</option>');

        $.ajax({
            url: `/application/get-technical-areas/${mainId}`,
            type: 'GET',
            success: function (areas) {
                $('#technical-area').empty().append('<option selected disabled>Select Technical Area</option>');
                areas.forEach(area => {
                    $('#technical-area').append(`<option value="${area.id}">${area.technical_area}</option>`);
                });
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function (descriptions) {
                ...
                descriptions.forEach(desc => {
                    $('#description-select').append(`<option value="${desc.description}">${desc.description}</option>`);
                });
            }
        });
    });
    ...
    $('#clusterSelect').on('change', function () {
        ...
        if (clusterId) {
            $.ajax({
                ...
                success: function (data) {
                    $('#categorySelect').empty().append('<option selected disabled>Select Category</option>');
                    $('#subcategorySelect').empty().append('<option selected disabled>Select Sub-Category</option>');
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (key, sub) {
                        $('#subcategorySelect').append('<option value="' + sub.sub_name + '">' + sub.sub_name + '</option>');
                    });
                }
            });
        }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    scopeButtons.forEach(button => {
        button.addEventListener('click', function () {
            const type = button.getAttribute('data-type'); // Now this matches the ID exactly
