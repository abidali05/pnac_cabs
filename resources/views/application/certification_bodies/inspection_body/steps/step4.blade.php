<form method="POST" action="{{ route('inspection-body.step4.save', ['application' => $application->id]) }}"
    ...
    <div class="row g-3">
        {{-- Type Declaration --}}
        <div class="col-12">
            <h6 class="fw-bold">Inspection Body Type Declaration</h6>
        ...
        {{-- Declarations --}}
        <div class="col-12 mt-3"><h6 class="fw-bold">Declarations</h6></div>
        @php
            $declChecks = [
        ...
        {{-- Fee & Signature --}}
        <div class="col-12 mt-3"><h6 class="fw-bold">Applicant Fee &amp; Signature</h6></div>
        <div class="col-md-4">
