                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $proficiency->organisation }}" name="organisation" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address of Proficiency Testing Provider</label>
                            <input type="text" value="{{ $proficiency->address }}" name="address" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{ $proficiency->postcode }}" name="postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $proficiency->tel }}" name="tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $proficiency->fax }}" name="fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $proficiency->contact_name }}" name="contact_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Designation:</label>
                            <input type="text" value="{{ $proficiency->designation }}" name="designation" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address:</label>
                            <input type="text" value="{{ $proficiency->person_address }}" name="person_address" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Postcode</label>
                                <input type="text" value="{{ $proficiency->person_postcode }}" name="person_postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Tel</label>
                                <input type="text" value="{{ $proficiency->person_tel }}" name="person_tel" readonly class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Fax</label>
                                <input type="text" value="{{ $proficiency->person_fax }}" name="person_fax" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>E-mail</label>
                                <input type="email" value="{{ $proficiency->person_email }}" name="person_email" readonly class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label for=""> A copy of the Proficiency Testing Provider's Technical Procedures and work instructions readonly by the standard.</label>
                        </div>
                        <div class="form-group">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" value="{{ $proficiency->selves_title }}" name="selves_title" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>name</label>
                            <input type="text" value="{{ $proficiency->selves_name }}" name="selves_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Position</label>
                            <input type="text" value="{{ $proficiency->selves_position }}" name="selves_position" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $proficiency->selves_parent_organization }}" name="selves_parent_organization" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $proficiency->selves_address }}" name="selves_address" readonly class="form-control">
                        </div>

                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{ $proficiency->selves_postcode }}" name="selves_postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $proficiency->selves_tel }}" name="selves_tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $proficiency->selves_fax }}" name="selves_fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Organization</label>
                            <input type="text" value="{{ $proficiency->selves_invoicing_organization }}" name="selves_invoicing_organization" readonly class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $proficiency->selves_invoicing_address }}" name="selves_invoicing_address" readonly class="form-control">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $proficiency->selves_invoicing_tel }}" name="selves_invoicing_tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $proficiency->selves_invoicing_fax }}" name="selves_invoicing_fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $proficiency->selves_other_describe }}" name="selves_other_describe" readonly class="form-control">
                        </div>
                        <div class="form-group">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $proficiency->staff_name }}" name="staff_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $proficiency->staff_qualifications }}" name="staff_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $proficiency->staff_relevant }}" name="staff_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $proficiency->staff_exp }}" name="staff_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $proficiency->staff_quality_name }}" name="staff_quality_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $proficiency->staff_quality_qualifications }}" name="staff_quality_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $proficiency->staff_quality_relevant }}" name="staff_quality_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $proficiency->staff_quality_exp }}" name="staff_quality_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $proficiency->staff_coordinator_name }}" name="staff_coordinator_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $proficiency->staff_coordinator_qualifications }}" name="staff_coordinator_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $proficiency->staff_coordinator_relevant }}" name="staff_coordinator_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $proficiency->staff_coordinator_exp }}" name="staff_coordinator_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <h6>C.	Statistian</h6>
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $proficiency->staff_statistian_name }}" name="staff_statistian_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $proficiency->staff_statistian_qualifications }}" name="staff_statistian_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $proficiency->staff_statistian_relevant }}" name="staff_statistian_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $proficiency->staff_statistian_exp }}" name="staff_statistian_exp" readonly class="form-control">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $proficiency->scop_parameter }}" name="scop_parameter" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Proficiency Testing Items/ Materials/ Matrix/Products (eg Reinforced Steel Bars)</label>
                            <input type="text" value="{{ $proficiency->scop_testing }}" name="scop_testing" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Number of Proficiency Test Item Round (e.g 5 nos)</label>
                            <input type="text" value="{{ $proficiency->scop_round }}" name="scop_round" readonly class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $proficiency->scop_equipment }}" name="scop_equipment" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Date of last calibration</label>
                            <input type="text" value="{{ $proficiency->scop_last_date }}" name="scop_last_date" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Date of next calibration</label>
                            <input type="text" value="{{ $proficiency->scop_next_date }}" name="scop_next_date" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Calibration Organization</label>
                            <input type="text" value="{{ $proficiency->scop_calibration }}" name="scop_calibration" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Details of in-house Checks performed</label>
                            <input type="text" value="{{ $proficiency->scop_details }}" name="scop_details" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Tests for which used and other comments</label>
                            <input type="text" value="{{ $proficiency->scop_comments }}" name="scop_comments" readonly class="form-control">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea readonly name="approvals_name" class="form-control">{{ $proficiency->approvals_name }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Scope of accreditation/approval and number of certificate (if any)</label>
                            <textarea readonly name="approvals_scope" class="form-control">{{ $proficiency->approvals_scope }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Start</label>
                                <input type="date" name="approvals_start_date" value="{{ $proficiency->approvals_start_date }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Expiry Date</label>
                                <input type="date" name="approvals_end_date" value="{{ $proficiency->approvals_end_date }}" readonly class="form-control">
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Date</label>
                                <input type="date" name="declaration_date" value="{{ $proficiency->declaration_date }}" readonly class="form-control">
                            </div>
                        </div>
