                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="organisation" value="{{ $application->organisation }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address of laboratory</label>
                            <input type="text" name="address_laboratory" value="{{ $application->address_laboratory }}" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" name="postcode" value="{{ $application->postcode }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" name="tel" value="{{ $application->tel }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" name="fax" value="{{ $application->fax }}" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="contact_name" value="{{ $application->contact_name }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Designation:</label>
                            <input type="text" name="designation" value="{{ $application->designation }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address:</label>
                            <input type="text" name="person_address" value="{{ $application->person_address }}" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Postcode</label>
                                <input type="text" name="person_postcode" value="{{ $application->person_postcode }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Tel</label>
                                <input type="text" name="person_tel" value="{{ $application->person_tel }}" readonly class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Fax</label>
                                <input type="text" name="person_fax" value="{{ $application->person_fax }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>E-mail</label>
                                <input type="email" name="person_email" value="{{ $application->person_email }}" readonly class="form-control">
                            </div>
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" name="selves_title" value="{{ $application->selves_title }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>name</label>
                            <input type="text" name="selves_name" value="{{ $application->selves_name }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Position</label>
                            <input type="text" name="selves_position" value="{{ $application->selves_position }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Parent</label>
                            <input type="text" name="selves_parent" value="{{ $application->selves_parent }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="selves_relationship" value="{{ $application->selves_relationship }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>With Parent</label>
                            <input type="text" name="selves_with_parent" value="{{ $application->selves_with_parent }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Organization</label>
                        ...
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" name="selves_address" value="{{ $application->selves_address }}" readonly class="form-control">
                        </div>

                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" name="selves_postcode" value="{{ $application->selves_postcode }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" name="selves_tel" value="{{ $application->selves_tel }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" name="selves_fax" value="{{ $application->selves_fax }}" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Organization</label>
                            <input type="text" name="selves_organization_three" value="{{ $application->selves_organization_three }}" readonly class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" name="selves_address_three" value="{{ $application->selves_address_three }}" readonly class="form-control">
                        </div>

                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" name="selves_postcode_three" value="{{ $application->selves_postcode_three }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" name="selves_tel_three" value="{{ $application->selves_tel_three }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" name="selves_fax_three" value="{{ $application->selves_fax_three }}" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="selves_other_describe" value="{{ $application->selves_other_describe }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="selves_name_seven" value="{{ $application->selves_name_seven }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Organisation(if any)</label>
                            <input type="text" name="selves_organisation_any" value="{{ $application->selves_organisation_any }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" name="selves_address_seven" value="{{ $application->selves_address_seven }}" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Postcode</label>
                                <input type="text" name="selves_postcode_seven" value="{{ $application->selves_postcode_seven }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Tel</label>
                                <input type="text" name="selves_tel_seven" value="{{ $application->selves_tel_seven }}" readonly class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Fax</label>
                                <input type="text" name="selves_fax_seven" value="{{ $application->selves_fax_seven }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>E-mail</label>
                                <input type="email" name="selves_email_seven" value="{{ $application->selves_email_seven }}" readonly class="form-control">
                            </div>
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="staff_name" value="{{ $application->staff_name }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" name="staff_qualifications" value="{{ $application->staff_qualifications }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" name="staff_relevant" value="{{ $application->staff_relevant }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" name="staff_experience" value="{{ $application->staff_experience }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="staff_quality_name" value="{{ $application->staff_quality_name }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" name="staff_quality_qualifications" value="{{ $application->staff_quality_qualifications }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" name="staff_quality_relevant" value="{{ $application->staff_quality_relevant }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" name="staff_quality_experience" value="{{ $application->staff_quality_experience }}" readonly class="form-control">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea readonly name="scop_calib_measurement" readonly class="form-control">{{ $application->scop_calib_measurement }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Range</label>
                            <textarea readonly name="scop_calib_range" readonly class="form-control">{{ $application->scop_calib_range }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>*Expanded Uncertainty( +  )</label>
                            <textarea readonly name="scop_calib_expanded" readonly class="form-control">{{ $application->scop_calib_expanded }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Technique, Reference Standard, Equipment</label>
                            <textarea readonly name="scop_calib_technique" readonly class="form-control">{{ $application->scop_calib_technique }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea readonly name="scop_description" readonly class="form-control">{{ $application->scop_description }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Working Range/ capacity of equipment and other relevant information</label>
                            <textarea readonly name="scop_working" readonly class="form-control">{{ $application->scop_working }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Minimum detection limit</label>
                            <textarea readonly name="scop_limit" readonly class="form-control">{{ $application->scop_limit }}</textarea>
                        </div> --}}
                    ...
                    <div class="card-body">
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <textarea readonly name="scop_materials" readonly class="form-control">{{ $application->scop_materials }}
                            </textarea>
                        </div>
                        <div class="form-group">
                            <label>Types of test/Properties measured</label>
                            <textarea readonly name="scop_types" readonly class="form-control">{{ $application->scop_types }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Range of measurement</label>
                            <textarea readonly name="scop_range" readonly class="form-control">{{ $application->scop_range }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Minimum detection limit</label>
                            <textarea readonly name="scop_detection" readonly class="form-control">{{ $application->scop_detection }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Uncertainty of Measurement (where applicable)
                                ( + )
                            </label>
                            <textarea readonly name="scop_uncertainty" readonly class="form-control">{{ $application->scop_uncertainty }}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Standard specification/Techniques/equipment used</label>
                            <textarea readonly name="scop_standard" readonly class="form-control">{{ $application->scop_standard }}</textarea>
                        </div>
                        <div class="form-group">
                            <h6>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <textarea readonly name="calibration_fully_comment" readonly class="form-control">{{ $application->calibration_fully_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="calibration_record_comment" class="form-control">{{ $application->calibration_record_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="calibration_adequate_comment" class="form-control">{{ $application->calibration_adequate_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="calibration_procedures_comment" class="form-control">{{ $application->calibration_procedures_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="calibration_internal_comment" class="form-control">{{ $application->calibration_internal_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="calibration_pnac_comment" class="form-control">{{ $application->calibration_pnac }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="calibration_other_comment" class="form-control">{{ $application->calibration_other_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="calibration_lab_comment" class="form-control">{{ $application->calibration_lab }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea readonly name="calibration_compliance" class="form-control">{{ $application->calibration_compliance }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Rectified by (date)</label>
                            <textarea readonly name="calibration_rectified" class="form-control">{{ $application->calibration_rectified }}</textarea>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea readonly name="approvals_name" class="form-control">{{ $application->approvals_name }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>calibrationFacility of accreditation/approval and number of certificate (if any)</label>
                            <textarea readonly name="approvals_scope" class="form-control">{{ $application->approvals_scope }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Start</label>
                                <input type="date" name="approvals_start_date" value="{{ $application->approvals_start_date }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Expiry Date</label>
                                <input type="date" name="approvals_end_date" value="{{ $application->approvals_end_date }}" readonly class="form-control">
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Date</label>
                                <input type="date" name="date" value="{{ $application->date }}" readonly class="form-control">
                            </div>
                        </div>
