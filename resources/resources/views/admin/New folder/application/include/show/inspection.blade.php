                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $inspection->inspection_body }}" name="inspection_body" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $inspection->general_address }}" name="general_address" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{ $inspection->postcode }}" name="postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $inspection->tel }}" name="tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $inspection->fax }}" name="fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $inspection->contact_name }}" name="contact_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Designation:</label>
                            <input type="text" value="{{ $inspection->designation }}" name="designation" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address:</label>
                            <input type="text" value="{{ $inspection->person_address }}" name="person_address" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Postcode</label>
                                <input type="text" value="{{ $inspection->person_postcode }}" name="person_postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Tel</label>
                                <input type="text" value="{{ $inspection->person_tel }}" name="person_tel" readonly class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Fax</label>
                                <input type="text" value="{{ $inspection->person_fax }}" name="person_fax" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>E-mail</label>
                                <input type="email" value="{{ $inspection->person_email }}" name="person_email" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group col-6">
                            <label>Details of sub-offices/marketing</label>
                            <input type="text" name="sub_offices" value="{{ $inspection->sub_offices }}" readonly class="form-control">
                        </div>
                        <div class="form-group col-6">
                            <label>offices in other cities</label>
                            <input type="text" name="offices_cities" value="{{ $inspection->offices_cities }}" readonly class="form-control">
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" value="{{ $inspection->organized_title }}" name="organized_title" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>name</label>
                            <input type="text" value="{{ $inspection->organized_name }}" name="organized_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Position</label>
                            <input type="text" value="{{ $inspection->organized_position }}" name="organized_position" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $inspection->organized_parent_organization }}" name="organized_parent_organization" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relationship with Parent Organization</label>
                            <input type="text" value="{{ $inspection->organized_parent_relationship }}" name="organized_parent_relationship" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $inspection->organized_parent_address }}" name="organized_parent_address" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Postcode</label>
                            <input type="text" value="{{ $inspection->organized_parent_postcode }}" name="organized_parent_postcode" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Tel</label>
                            <input type="text" value="{{ $inspection->organized_parent_tel }}" name="organized_parent_tel" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Fax</label>
                            <input type="text" value="{{ $inspection->organized_parent_fax }}" name="organized_parent_fax" readonly class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $inspection->organized_invoicing_organization }}" name="organized_invoicing_organization" readonly class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $inspection->organized_invoicing_address }}" name="organized_invoicing_address" readonly class="form-control">
                        </div>

                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{ $inspection->organized_invoicing_postcode }}" name="organized_invoicing_postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $inspection->organized_invoicing_tel }}" name="organized_invoicing_tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $inspection->organized_invoicing_fax }}" name="organized_invoicing_fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $inspection->staff_chief_name }}" name="staff_chief_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $inspection->staff_chief_qualifications }}" name="staff_chief_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $inspection->staff_chief_relevant }}" name="staff_chief_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $inspection->staff_chief_exp }}" name="staff_chief_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $inspection->staff_quality_name }}" name="staff_quality_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $inspection->staff_quality_qualifications }}" name="staff_quality_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $inspection->staff_quality_relevant }}" name="staff_quality_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $inspection->staff_quality_exp }}" name="staff_quality_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $inspection->staff_manag_name }}" name="staff_manag_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $inspection->staff_manag_qualifications }}" name="staff_manag_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $inspection->staff_manag_relevant }}" name="staff_manag_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $inspection->staff_manag_exp }}" name="staff_manag_exp" readonly class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            <h5><b>A.	Inspectors,  permanent employees of the company;</b>
                                (If readonly please attach extra sheets)</h5>
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $inspection->staff_inspect_name }}" name="staff_inspect_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $inspection->staff_inspect_qualifications }}" name="staff_inspect_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Auditing Field</label>
                            <input type="text" value="{{ $inspection->staff_inspect_auditing }}" name="staff_inspect_auditing" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit  Experience</label>
                            <input type="text" value="{{ $inspection->staff_inspect_exp }}" name="staff_inspect_exp" readonly class="form-control">
                        </div>

                        <div class="form-group">
                            <h5>B.	Sub-contracted/Free lance/Empanelled Inspectors, not the permanent employees of the company. (If readonly please attach extra sheets)</h5>
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $inspection->staff_sub_name }}" name="staff_sub_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $inspection->staff_sub_qualifications }}" name="staff_sub_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Auditing Field</label>
                            <input type="text" value="{{ $inspection->staff_sub_auditing }}" name="staff_sub_auditing" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit  Experience</label>
                            <input type="text" value="{{ $inspection->staff_sub_exp }}" name="staff_sub_exp" readonly class="form-control">
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>
                                ...
                                <input type="text" value="{{ $inspection->scop_inspect_des }}" name="scop_inspect_des" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>
                            ...
                            <input type="text" value="{{ $inspection->scop_range }}" name="scop_range" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>
                            ...
                            <input type="text" value="{{ $inspection->scop_method }}" name="scop_method" readonly class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $inspection->scop_equipment }}" name="scop_equipment" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $inspection->scop_calibration }}" name="scop_calibration" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Frequency of  Calibration</label>
                            <input type="text" value="{{ $inspection->scop_economic_b }}" name="scop_economic_b" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Date of Last Calibration</label>
                            <input type="date" value="{{ $inspection->scop_last_calib }}" name="scop_last_calib" readonly class="form-control">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Date</label>
                                <input type="date" value="{{ $inspection->declaration_date }}" readonly name="declaration_date" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <h6>
