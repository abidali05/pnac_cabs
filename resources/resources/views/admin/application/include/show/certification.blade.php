                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{  $certification->certification_body }}" name="certification_body" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{  $certification->general_address }}" name="general_address" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{  $certification->postcode }}" name="postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{  $certification->tel }}" name="tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{  $certification->fax }}" name="fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{  $certification->contact_name }}" name="contact_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Designation:</label>
                            <input type="text" value="{{  $certification->designation }}" name="designation" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address:</label>
                            <input type="text" value="{{  $certification->person_address }}" name="person_address" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Postcode</label>
                                <input type="text" value="{{  $certification->person_postcode }}" name="person_postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Tel</label>
                                <input type="text" value="{{  $certification->person_tel }}" name="person_tel" readonly class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Fax</label>
                                <input type="text" value="{{  $certification->person_fax }}" name="person_fax" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>E-mail</label>
                                <input type="email" name="person_email" value="{{  $certification->person_email }}" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group col-6">
                            <label>Details of sub-offices/marketing</label>
                            <input type="text" name="sub_offices" value="{{  $certification->sub_offices }}" readonly class="form-control">
                        </div>
                        <div class="form-group col-6">
                            <label>offices in other cities</label>
                            <input type="text" name="offices_cities" value="{{  $certification->offices_cities }}" readonly class="form-control">
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" value="{{  $certification->selves_title }}" name="selves_title" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>name</label>
                            <input type="text" value="{{  $certification->selves_name }}" name="selves_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Position</label>
                            <input type="text" value="{{  $certification->selves_position }}" name="selves_position" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{  $certification->selves_parent_organization }}" name="selves_parent_organization" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relationship with Parent Organization</label>
                            <input type="text" value="{{  $certification->selves_parent_relationship }}" name="selves_parent_relationship" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{  $certification->selves_parent_address }}" name="selves_parent_address" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Postcode</label>
                            <input type="text" value="{{  $certification->selves_parent_postcode }}" name="selves_parent_postcode" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Tel</label>
                            <input type="text" value="{{  $certification->selves_parent_tel }}" name="selves_parent_tel" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Fax</label>
                            <input type="text" value="{{  $certification->selves_parent_fax }}" name="selves_parent_fax" readonly class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{  $certification->selves_invoicing_organization }}" name="selves_invoicing_organization" readonly class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{  $certification->selves_invoicing_address }}" name="selves_invoicing_address" readonly class="form-control">
                        </div>

                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{  $certification->selves_invoicing_postcode }}" name="selves_invoicing_postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{  $certification->selves_invoicing_tel }}" name="selves_invoicing_tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{  $certification->selves_invoicing_fax }}" name="selves_invoicing_fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{  $certification->selves_other_describe }}" name="selves_other_describe" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{  $certification->selves_main_activities }}" name="selves_main_activities" readonly class="form-control">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{  $certification->staff_chief_name }}" name="staff_chief_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{  $certification->staff_chief_qualifications }}" name="staff_chief_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{  $certification->staff_chief_relevant }}" name="staff_chief_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{  $certification->staff_chief_exp }}" name="staff_chief_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{  $certification->staff_quality_name }}" name="staff_quality_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{  $certification->staff_quality_qualifications }}" name="staff_quality_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{  $certification->staff_quality_relevant }}" name="staff_quality_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{  $certification->staff_quality_exp }}" name="staff_quality_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{  $certification->staff_manag_name }}" name="staff_manag_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{  $certification->staff_manag_qualifications }}" name="staff_manag_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{  $certification->staff_manag_relevant }}" name="staff_manag_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{  $certification->staff_manag_exp }}" name="staff_manag_exp" readonly class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            <h5>A. Assessors/Auditors (if readonly please attach extra sheets)</h5>
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{  $certification->staff_assessor_name }}" name="staff_assessor_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{  $certification->staff_assessor_qualifications }}" name="staff_assessor_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Auditing Field</label>
                            <input type="text" value="{{  $certification->staff_assessor_auditing }}" name="staff_assessor_auditing" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit Experience</label>
                            <input type="text" value="{{  $certification->staff_assessor_exp }}" name="staff_assessor_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <h5>B. Sub-contracted/Free lance/Empanelled Assessors/Auditors(if readonly please attach extra sheets)</h5>
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{  $certification->staff_sub_name }}" name="staff_sub_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{  $certification->staff_sub_qualifications }}" name="staff_sub_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Auditing Field</label>
                            <input type="text" value="{{  $certification->staff_sub_auditing }}" name="staff_sub_auditing" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit Experience</label>
                            <input type="text" value="{{  $certification->staff_sub_exp }}" name="staff_sub_exp" readonly class="form-control">
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <h5>
                                List all the sectors/areas which you seek accreditation. (if readonly please attach extra sheets)
                            </h5>
                        </div>
                        <div class="form-group">
                            <h6>
                        ...
                        <div class="form-group">
                            ...
                            <textarea readonly name="scop_technical_a" readonly class="form-control">{{  $certification->scop_technical_a }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>IAF code</label>
                            <textarea readonly name="scop_iaf_a" readonly class="form-control">{{  $certification->scop_iaf_a }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Description of economic sector/activity, according to IAF ID1</label>
                            <textarea readonly name="scop_economic_a" readonly class="form-control">{{  $certification->scop_economic_a }}</textarea>
                        </div>
                        <div class="form-group">
                            <h5>
                        ...
                        <div class="form-group">
                            <label>Technical Cluster</label>
                            <textarea readonly name="scop_technical_b" readonly class="form-control">{{  $certification->scop_technical_b }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>IAF code</label>
                            <textarea readonly name="scop_iaf_b" readonly class="form-control">{{  $certification->scop_iaf_b }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Description of economic sector/activity, according to IAF ID1</label>
                            <textarea readonly name="scop_economic_b" readonly class="form-control">{{  $certification->scop_economic_b }}</textarea>
                        </div>
                        <div class="form-group">
                            <h5>
                        ...
                        <div class="form-group">
                            <label>Technical Cluster</label>
                            <textarea readonly name="scop_technical_c" readonly class="form-control">{{  $certification->scop_technical_c }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>IAF code</label>
                            <textarea readonly name="scop_iaf_c" readonly class="form-control">{{  $certification->scop_iaf_c }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Description of economic sector/activity, according to IAF ID1</label>
                            <textarea readonly name="scop_economic_c" readonly class="form-control">{{  $certification->scop_economic_c }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <label>Cluster</label>
                            <input type="text" value="{{  $certification->scop_cluster }}" name="scop_cluster" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Category</label>
                            <input type="text" value="{{  $certification->scop_category }}" name="scop_category" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Sub-Category</label>
                            <input type="text" value="{{  $certification->scop_subcategory }}" name="scop_subcategory" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Activities</label>
                            <input type="text" value="{{  $certification->scop_activity }}" name="scop_activity" readonly class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{  $certification->scop_main_tech }}" name="scop_main_tech" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Technical Areas</label>
                            <input type="text" value="{{  $certification->scop_areas }}" name="scop_areas" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Product Categories Covered by the Technical Areas</label>
                            <input type="text" value="{{  $certification->scop_product }}" name="scop_product" readonly class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea readonly name="scop_uncertainty" readonly class="form-control">{{  $certification->scop_uncertainty }}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Standard specification/Techniques/equipment used</label>
                            <textarea readonly name="scop_standard" readonly class="form-control">{{  $certification->scop_standard }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>*Quality Control Measures</label>
                            <textarea readonly name="scop_quality" readonly class="form-control">{{  $certification->scop_quality }}</textarea>
                        </div>
                        <div class="form-group">
                            <h6>
                        ...
                        <div class="form-group">
                            ...
                            <textarea readonly name="scop_major_name" readonly class="form-control">{{  $certification->scop_major_name }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Model/Type/year of make</label>
                            <textarea readonly name="scop_major_model" readonly class="form-control">{{  $certification->scop_major_model }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Working Range/capacity of equipment</label>
                            <textarea readonly name="scop_major_working" readonly class="form-control">{{  $certification->scop_major_working }}</textarea>
                            <div class="form-group">
                                <label>Minimum detection limit</label>
                                <textarea readonly name="scop_major_minimum" readonly class="form-control">{{  $certification->scop_major_minimum }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Last date of calibration</label>
                                <textarea readonly name="scop_major_lastdate" readonly class="form-control">{{  $certification->scop_major_lastdate }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Calibration due date</label>
                                <textarea readonly name="scop_major_duedate" readonly class="form-control">{{  $certification->scop_major_duedate }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Test for which used and other relevant information</label>
                                <textarea readonly name="scop_major_test" readonly class="form-control">{{  $certification->scop_major_test }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Name of Equipment</label>
                                <textarea readonly name="scop_reference_name" readonly class="form-control">{{  $certification->scop_reference_name }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Source/Supplier’s name</label>
                                <textarea readonly name="scop_reference_source" readonly class="form-control">{{  $certification->scop_reference_source }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Date of expiry/validity</label>
                                <textarea readonly name="scop_reference_date_ex" readonly class="form-control">{{  $certification->scop_reference_date_ex }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Traceability</label>
                                <textarea readonly name="scop_reference_traceability" readonly class="form-control">{{  $certification->scop_reference_traceability }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Purpose of use</label>
                                <textarea readonly name="scop_reference_purpose" readonly class="form-control">{{  $certification->scop_reference_purpose }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea readonly name="scop_proficiency_product" readonly class="form-control">{{  $certification->scop_proficiency_product }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Details of Test(s)/examination</label>
                                <textarea readonly name="scop_proficiency_details" readonly class="form-control">{{  $certification->scop_proficiency_details }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Date of testing/examination</label>
                                <textarea readonly name="scop_proficiency_date" readonly class="form-control">{{  $certification->scop_proficiency_date }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Organizing body</label>
                                <textarea readonly name="scop_proficiency_organizing" readonly class="form-control">{{  $certification->scop_proficiency_organizing }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Performance in term of Z -score or any other criteria</label>
                                <textarea readonly name="scop_proficiency_performance" readonly class="form-control">{{  $certification->scop_proficiency_performance }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Corrective actions taken (if readonly)</label>
                                <textarea readonly name="scop_proficiency_corrective" readonly class="form-control">{{  $certification->scop_proficiency_corrective }}</textarea>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{  $certification->quality_noncompliance }}" name="quality_noncompliance" readonly class="form-control">

                        </div>
                        <div class="form-group">
                            <label for="">Rectified by (date)</label>
                            <input type="date" name="quality_rect_date" value="{{  $certification->quality_rect_date }}" readonly class="form-control">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{  $certification->quality_name }}" name="quality_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Scope of accreditation/approval and number of certificate (if any)</label>
                            <input type="text" value="{{  $certification->quality_accreditation }}" name="quality_accreditation" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="quality_start_date" value="{{  $certification->quality_start_date }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Expiry Date</label>
                            <input type="date" name="quality_expiry_date" value="{{  $certification->quality_expiry_date }}" readonly class="form-control">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Date</label>
                                <input type="date" name="date" value="{{  $certification->date }}" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <h6>
