                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="hala_body" value="{{ $halal->hala_body }}" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $halal->address }}" name="address" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{ $halal->postcode }}" name="postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $halal->tel }}" name="tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $halal->fax }}" name="fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $halal->contact_name }}" name="contact_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Designation:</label>
                            <input type="text" value="{{ $halal->designation }}" name="designation" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address:</label>
                            <input type="text" value="{{ $halal->person_address }}" name="person_address" readonly class="form-control">
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Postcode</label>
                                <input type="text" value="{{ $halal->person_postcode }}" name="person_postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Tel</label>
                                <input type="text" value="{{ $halal->person_tel }}" name="person_tel" readonly class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Fax</label>
                                <input type="text" value="{{ $halal->person_fax }}" name="person_fax" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>E-mail</label>
                                <input type="email" value="{{ $halal->person_email }}" name="person_email" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Details of sub-offices/marketing offices in other cities</label>
                            <input type="text" value="{{ $halal->person_detail }}" name="person_detail" readonly class="form-control">
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" value="{{ $halal->selves_title }}" name="selves_title" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>name</label>
                            <input type="text" value="{{ $halal->selves_name }}" name="selves_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Position</label>
                            <input type="text" value="{{ $halal->selves_position }}" name="selves_position" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $halal->selves_parent_organization }}" name="selves_parent_organization" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $halal->selves_address }}" name="selves_address" readonly class="form-control">
                        </div>

                        <div class="row">
                            <div class="form-group col-4">
                                <label>Postcode</label>
                                <input type="text" value="{{ $halal->selves_postcode }}" name="selves_postcode" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $halal->selves_tel }}" name="selves_tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $halal->selves_fax }}" name="selves_fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Organization</label>
                            <input type="text" value="{{ $halal->selves_invoicing_organization }}" name="selves_invoicing_organization" readonly class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" value="{{ $halal->selves_invoicing_address }}" name="selves_invoicing_address" readonly class="form-control">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-4">
                                <label>Tel</label>
                                <input type="text" value="{{ $halal->selves_invoicing_tel }}" name="selves_invoicing_tel" readonly class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Fax</label>
                                <input type="text" value="{{ $halal->selves_invoicing_fax }}" name="selves_invoicing_fax" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $halal->selves_other_describe }}" name="selves_other_describe" readonly class="form-control">
                        </div>
                        <div class="form-group">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $halal->staff_chief_name }}" name="staff_chief_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Religion</label>
                            <input type="text" value="{{ $halal->staff_chief_religion }}" name="staff_chief_religion" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $halal->staff_chief_qualifications }}" name="staff_chief_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $halal->staff_chief_relevant }}" name="staff_chief_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $halal->staff_chief_exp }}" name="staff_chief_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $halal->staff_shariah_name }}" name="staff_shariah_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Religion</label>
                            <input type="text" value="{{ $halal->staff_shariah_religion }}" name="staff_shariah_religion" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $halal->staff_shariah_qualifications }}" name="staff_shariah_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $halal->staff_shariah_relevant }}" name="staff_shariah_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $halal->staff_shariah_exp }}" name="staff_shariah_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $halal->staff_quality_name }}" name="staff_quality_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Religion</label>
                            <input type="text" value="{{ $halal->staff_quality_religion }}" name="staff_quality_religion" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $halal->staff_quality_qualifications }}" name="staff_quality_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $halal->staff_quality_relevant }}" name="staff_quality_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $halal->staff_quality_exp }}" name="staff_quality_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $halal->staff_manage_name }}" name="staff_manage_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Religion</label>
                            <input type="text" value="{{ $halal->staff_manage_religion }}" name="staff_manage_religion" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $halal->staff_manage_qualifications }}" name="staff_manage_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Relevant</label>
                            <input type="text" value="{{ $halal->staff_manage_relevant }}" name="staff_manage_relevant" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Experience</label>
                            <input type="text" value="{{ $halal->staff_manage_exp }}" name="staff_manage_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $halal->staff_audit_name }}" name="staff_audit_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Religion</label>
                            <input type="text" value="{{ $halal->staff_audit_religion }}" name="staff_audit_religion" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $halal->staff_audit_qualifications }}" name="staff_audit_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit Field</label>
                            <input type="text" value="{{ $halal->staff_audit_field }}" name="staff_audit_field" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit Experience</label>
                            <input type="text" value="{{ $halal->staff_audit_exp }}" name="staff_audit_exp" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <p>
                                B.	 Please list the name, qualification, relevant auditing field and experience of the Auditors/Experts who are not the permanent employees of the company like Sub-contracted/Free lance/Empanelled Auditors/Experts (if readonly please attach extra sheets)
                            </p>
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="{{ $halal->staff_list_name }}" name="staff_list_name" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Religion</label>
                            <input type="text" value="{{ $halal->staff_list_religion }}" name="staff_list_religion" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Qualifications</label>
                            <input type="text" value="{{ $halal->staff_list_qualifications }}" name="staff_list_qualifications" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit Field</label>
                            <input type="text" value="{{ $halal-> staff_list_field}}" name="staff_list_field" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Audit Experience</label>
                            <input type="text" value="{{ $halal->staff_list_exp }}" name="staff_list_exp" readonly class="form-control">
                        </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <p>
                                ...
                                List all the sectors/areas readonly for accreditation (if readonly please attach extra sheets)
                            </p>
                        </div>
                        <div class="form-group">
                            <label>Cat. Code</label>
                            <input type="text" value="{{ $halal->scop_cat_code }}" name="scop_cat_code" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Category</label>
                            <input type="text" value="{{ $halal->scop_category }}" name="scop_category" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Category Example</label>
                            <input type="text" value="{{ $halal->scop_cat_exap }}" name="scop_cat_exap" readonly class="form-control">
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <textarea name="org_quality_comment" readonly class="form-control">{{ $halal->org_quality_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <textarea name="org_policy_comment" class="form-control" readonly>{{ $halal->org_policy_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea name="org_procedures_comment" class="form-control" readonly>{{ $halal->org_procedures_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="org_manual_comment" class="form-control">{{ $halal->org_manual_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="org_shariah_comment" class="form-control">{{ $halal->org_shariah_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="org_qmr_comment" class="form-control">{{ $halal->org_qmr_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="org_hcb_comment" class="form-control">{{ $halal->org_hcb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="org_referred_comment" class="form-control">{{ $halal->org_referred_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <h5>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_doc_comment" class="form-control">{{ $halal->quality_doc_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_frequently_comment" class="form-control">{{ $halal->quality_frequently_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_records_comment" class="form-control">{{ $halal->quality_records_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_hcb_comment" class="form-control">{{ $halal->quality_hcb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="quality_review_comment" class="form-control">{{ $halal->quality_review_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="halal_quality_comment" class="form-control">{{ $halal->halal_quality_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="halal_appropriate_comment" class="form-control">{{ $halal->halal_appropriate_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="halal_doc_comment" class="form-control">{{ $halal->halal_doc_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <h5>D.  Procedures</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="proced_doc_comment" class="form-control">{{ $halal->proced_doc_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="proced_referred_comment" class="form-control">{{ $halal->proced_referred_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <h5>E. 	Records</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="record_prescribed_comment" class="form-control">{{ $halal->record_prescribed_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="record_arrang_comment" class="form-control">{{ $halal->record_arrang_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="record_hcb_comment" class="form-control">{{ $halal->record_hcb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <h5>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="complaint_hcb_comment" class="form-control">{{ $halal->complaint_hcb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="complaint_record_comment" class="form-control">{{ $halal->complaint_record_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <h5>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="subcontract_hcb_comment" class="form-control">{{ $halal->subcontract_hcb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="subcontract_cb_comment" class="form-control">{{ $halal->subcontract_cb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="subcontract_register_comment" class="form-control">{{ $halal->subcontract_register_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <h5>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="outside_doc_comment" class="form-control">{{ $halal->outside_doc_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Reference/other comment</label>
                                <textarea readonly name="outside_hcb_comment" class="form-control">{{ $halal->outside_hcb_comment }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" value="{{ $halal->rectified_date }}" name="rectified_date" readonly class="form-control">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea readonly name="approvals_name" class="form-control">{{ $halal->approvals_name }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Scope of accreditation/approval and number of certificate (if any)</label>
                            <textarea readonly name="approvals_scope" class="form-control">{{ $halal->approvals_scope }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Start</label>
                                <input type="date" name="approvals_start_date" value="{{ $halal->approvals_start_date }}" readonly class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Expiry Date</label>
                                <input type="date" name="approvals_end_date" value="{{ $halal->approvals_end_date }}" readonly class="form-control">
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Date</label>
                                <input type="date" name="declaration_date" value="{{ $halal->declaration_date }}" readonly class="form-control">
                            </div>
                        </div>
                        <div class="form-group col-6">
                            <h5>
