...
<form action="{{ route('application.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <section class="section">
        ...
        {{-- {{ dd($scheme_name) }} --}}
        <div class="row section-form application-section-form" id="GeneralInfo-form">
        ...
        <div class="row section-form application-section-form" id="AboutYourselves-form">
            <div class="col-12 col-md-12 col-lg-12">
        ...
        <div class="row section-form application-section-form" id="AboutYourStaff-form">
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="scop_calib_measurement" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Range</label>
                            <textarea name="scop_calib_range" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label>*Expanded Uncertainty( +  )</label>
                            <textarea name="scop_calib_expanded" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Technique, Reference Standard, Equipment</label>
                            <textarea name="scop_calib_technique" required class="form-control"></textarea>
                        </div>
        ...
        <div class="row section-form application-section-form" id="CalibrationFacility-form">
            <div class="col-12 col-md-12 col-lg-12">
        ...
        <div class="row section-form application-section-form" id="OtherApprovals-form">
            <div class="col-12 col-md-12 col-lg-12">
        ...
        <div class="row section-form application-section-form" id="Declaration-form">
            <div class="col-12 col-md-12 col-lg-12">
                        ...
                        <div class="footer">
                            <div class="form-navigation d-flex justify-content-center mt-1 mb-5">
                                ...
                                <div class="submit-btn-wrapper d-none">
                                    ...
                                    {{-- <button type="button" class="btn btn-info" id="viewFormBtn">View Summary</button>&nbsp;&nbsp; --}}
