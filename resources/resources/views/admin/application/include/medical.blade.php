                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="address_medical" required class="form-control">
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Mobile</label>
                                <input type="text" name="person_mobile" required class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="clinical_chemistry">
                            <label for="">Clinical Chemistry</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="haematology">
                            <label for="">Haematology</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="histopathology">
                            <label for="">Histopathology</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="immunology">
                            <label for="">Immunology</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="microbiology">
                            <label for="">Microbiology</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="molecular_biology">
                            <label for="">Molecular Biology</label>
                        </div>
                        <div class="form-group">
                            <label for="">Other (Please describe)</label>
                            <input type="text" name="other_describe" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="chack_recognised">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Postcode</label>
                            <input type="text" name="selves_parent_postcode" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Tel</label>
                            <input type="text" name="selves_parent_tel" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Fax</label>
                            <input type="text" name="selves_parent_fax" required class="form-control">
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <input type="checkbox" name="selves_hospital">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <input type="radio" name="selves_permanent_facility" value="Yes"> Yes
                                <input type="radio" name="selves_permanent_facility" value="No"> No
                            </div>
                            <div class="form-group col-6">
                                <label>B. Sample Collection Centre If yes attach list of sample collection centres</label>
                            </div>
                            <div class="form-group col-6">
                                <input type="radio" name="selves_sample_collection" value="Yes"> Yes
                                <input type="radio" name="selves_sample_collection" value="No"> No
                            </div>
                            <div class="form-group col-6">
                                <label>C. Temporary Facility (when a facility is created temporarily).</label>
                            </div>
                            <div class="form-group col-6">
                                <input type="radio" name="selves_temporary_facility" value="Yes"> Yes
                                <input type="radio" name="selves_temporary_facility" value="No"> No
                            </div>
                            <div class="form-group col-6">
                                <label>D. Mobile Laboratory.</label>
                            </div>
                            <div class="form-group col-6">
                                <input type="radio" name="selves_mobile_laboratory" value="Yes"> Yes
                                <input type="radio" name="selves_mobile_laboratory" value="No"> No
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="staff_laboratory" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="staff_qualification" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="staff_authorised" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label> Specimen Signature</label>
                            <input type="text" name="staff_specimen" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label> Relevant Training</label>
                            <input type="text" name="staff_quality_training" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label> Specimen Signature</label>
                            <input type="text" name="staff_quality_specimen" required class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="staff_name_section" required class="form-control">
                        ...
                        <div class="row">
                            <div class="form-group d-flex">
                                <input type="text" name="staff_section_name" required class="form-control">
                                <input type="text" name="staff_section_qualification" required class="form-control">
                                <input type="text" name="staff_section_experience" required class="form-control">
                                <input type="text" name="staff_section_relevant" required class="form-control">
                                <input type="text" name="staff_section_authorised" required class="form-control">
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="scop_sample_type" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="scop_quality" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <h6>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="scop_major_name" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Model/Type/year of make</label>
                            <textarea name="scop_major_model" required class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Working Range/capacity of equipment</label>
                            <textarea name="scop_major_working" required class="form-control"></textarea>
                            <div class="form-group">
                                <label>Minimum detection limit</label>
                                <textarea name="scop_major_minimum" required class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Last date of calibration</label>
                                <textarea name="scop_major_lastdate" required class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Calibration due date</label>
                                <textarea name="scop_major_duedate" required class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Test for which used and other relevant information</label>
                                <textarea name="scop_major_test" required class="form-control"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Name of Equipment</label>
                                <textarea name="scop_reference_name" required class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Source/Supplier’s name</label>
                                <textarea name="scop_reference_source" required class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Date of expiry/validity</label>
                                <textarea name="scop_reference_date_ex" required class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Traceability</label>
                                <textarea name="scop_reference_traceability" required class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Purpose of use</label>
                                <textarea name="scop_reference_purpose" required class="form-control"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="scop_proficiency_product" required class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Details of Test(s)/examination</label>
                                <textarea name="scop_proficiency_details" required class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Date of testing/examination</label>
                                <textarea name="scop_proficiency_date" required class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Organizing body</label>
                                <textarea name="scop_proficiency_organizing" required class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Performance in term of Z -score or any other criteria</label>
                                <textarea name="scop_proficiency_performance" required class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Corrective actions taken (if required)</label>
                                <textarea name="scop_proficiency_corrective" required class="form-control"></textarea>
                            </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <input type="radio" name="quality_fully" value="Yes">
                                <label for="" class="col-3">Yes</label>
                                <input type="radio" name="quality_fully" value="No">
                                <label for="">No</label>
                            </div>
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea name="quality_fully_comment" required class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <input type="radio" name="quality_adequate" value="Yes">
                                <label for="" class="col-3">Yes</label>
                                <input type="radio" name="quality_adequate" value="No">
                                <label for="">No</label>
                            </div>
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea name="quality_adequate_comment" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <input type="radio" name="quality_procedures" value="Yes">
                                <label for="" class="col-3">Yes</label>
                                <input type="radio" name="quality_procedures" value="No">
                                <label for="">No</label>
                            </div>
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea name="quality_procedures_comment" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <input type="radio" name="quality_internal" value="Yes">
                                <label for="" class="col-3">Yes</label>
                                <input type="radio" name="quality_internal" value="No">
                                <label for="">No</label>
                            </div>
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea name="quality_internal_comment" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <input type="radio" name="quality_pnac" value="Yes">
                                <label for="" class="col-3">Yes</label>
                                <input type="radio" name="quality_pnac" value="No">
                                <label for="">No</label>
                            </div>
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea name="quality_pnac_comment" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <input type="radio" name="quality_other" value="Yes">
                                <label for="" class="col-3">Yes</label>
                                <input type="radio" name="quality_other" value="No">
                                <label for="">No</label>
                            </div>
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea name="quality_other_comment" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <input type="radio" name="quality_perform" value="Yes">
                                <label for="" class="col-3">Yes</label>
                                <input type="radio" name="quality_perform" value="No">
                                <label for="">No</label>
                            </div>
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea name="quality_perform_comment" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea name="quality_identified_comment" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Quality Manual reference/other comment</label>
                                <textarea name="quality_incorporate_comment" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <input type="radio" name="quality_compliance_consider" value="Yes">
                                <label for="" class="col-3">Yes</label>
                                <input type="radio" name="quality_compliance_consider" value="No">
                                <label for="">No</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="quality_compliance_specific" class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Area of non-compliance </label>
                            <textarea name="quality_compliance_area" class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Rectified by (date)</label>
                            <input type="date" name="quality_rectified" class="form-control">
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="declaration_clinical">
                            <label>Clinical Chemistry</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="declaration_haematology">
                            <label>Haematology</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="declaration_histopathology">
                            <label>Histopathology</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="declaration_immunology">
                            <label>Immunology</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="declaration_microbiology">
                            <label>Microbiology</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="declaration_moleculary">
                            <label>Molecular Biology</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="declaration_other">
                            <label>Other (Please describe)</label>
                            <input type="text" name="declaration_moleculary" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Signed</label>
                                <input type="file" name="signed" class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label>Date</label>
