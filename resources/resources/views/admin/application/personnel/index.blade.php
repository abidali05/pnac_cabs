                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-3">
                                    ...
                                    <a href="{{ route('application.view.scope', ['category' => 'Personnel Certification Bodies', 'scope' => 'ISO9001']) }}" class="card-link btn btn-warning ">View ISO 9001:2025</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-3">
                                    ...
                                    <a href="{{ route('application.view.scope', ['category' => 'Personnel Certification Bodies', 'scope' => 'ISO14001']) }}" class="card-link btn btn-warning px-4">View ISO 14001</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-3">
                                    ...
                                    <a href="{{ route('application.view.scope', ['category' => 'Personnel Certification Bodies', 'scope' => 'ISO45001']) }}" class="card-link btn btn-warning px-4">View ISO 45001</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-3">
                                    ...
                                    <a href="{{ route('application.view.scope', ['category' => 'Personnel Certification Bodies', 'scope' => 'ISO13485']) }}" class="card-link btn btn-warning px-4">View ISO 13485</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="bg-white border text-center iso-card shadow-sm mt-4" style="width: 20rem;">
                                <div class="card-body p-3">
                                    ...
                                    <a href="{{ route('application.view.scope', ['category' => 'Personnel Certification Bodies', 'scope' => 'ISO22000']) }}" class="card-link btn btn-warning px-4">View ISO 22000</a>
                                </div>
                            </div>
                        </div>
