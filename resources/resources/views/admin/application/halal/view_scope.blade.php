...
<div class="modal fade" id="scopeModal" tabindex="-1" aria-labelledby="scopeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form id="scopeForm" method="POST">
            ...
            <input type="hidden" name="category" value="halal">

            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Halal Certification Bodies</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <textarea name="cat_code" id="cat_code" required class="form-control"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Category</label>
                        <textarea name="scope_category" id="scope_category" required class="form-control"></textarea>
                    </div>

                    <div class="form-group">
                        <label>Sub Category</label>
                        <textarea name="subcategory" id="subcategory" required class="form-control"></textarea>
                    </div>
...
<script>
    ...
    function openScopeModal(data) {
        ...
        $('#scope_category').val(data.scope_category);
